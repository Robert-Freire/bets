...
tests/                      pytest suite (199 tests across 15 files; run with `pytest`)
...
| 9 | Infrastructure: **9a Pi cron ✅ Done 2026-05-01** · 9b–9d Azure migration **dev-side first** (Reply VSE subscription, two RGs: `kaunitz-dev-rg` now / `kaunitz-prod-rg` deferred to A.10). **A.0/A.1/A.2 ✅ Done 2026-05-01** (RG + serverless SQL DB `kaunitz` on `kaunitz-dev-sql-uksouth-rfk1` + Key Vault `kaunitz-dev-kv-rfk1` + 7-table schema). A.3–A.9 pending. See `docs/PLAN_AZURE_2026-05.md`. |
