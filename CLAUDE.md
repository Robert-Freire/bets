...
| 9 | Infrastructure: **9a Pi cron ✅ Done 2026-05-01** · 9b–9d Azure migration **dev-side first** (App Service + SQL DB, WSL CSVs only initially; Pi onboarding deferred to A.10) — A.0/A.1/A.2/A.3 ✅ Done 2026-05-01; A.4–A.9 pending — see `docs/PLAN_AZURE_2026-05.md` |
